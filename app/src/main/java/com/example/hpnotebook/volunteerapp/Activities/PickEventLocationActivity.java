...
public class PickEventLocationActivity extends AppCompatActivity implements OnMapReadyCallback,
    ...
    String event_title , event_description, event_date, event_time, event_location, event_category,
            event_stipend, event_refreshments, event_dresscode, event_language;
    Uri imageUri;
        ...
        button_submit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                addEvent(key, event_title, event_userId, event_description,
                        ...
                        event_language, event_latlng, event_users);
    ...
    private void addEvent(final String event_id, final String event_title, final String event_userId, final String event_description,
                          ...
                          final LatLng latLng, final ArrayList<User> event_users) {
                    ...
                    public void onComplete(@NonNull Task<Uri> task) {
                        if ((task.isSuccessful())) {
                            ...
                            Event event = new Event(event_id, event_title, event_userId,
                                    ...
                                    event_dresscode, event_language, imageUrl, latLng, event_users);
    ...
    private void init(){
        ...
        mPlacePicker.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                try {
                    startActivityForResult(builder.build(PickEventLocationActivity.this), PLACE_PICKER_REQUEST);
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        if (requestCode == PLACE_PICKER_REQUEST) {
            if (resultCode == RESULT_OK) {
                ...
                event_latlng = place.getLatLng();
                String event_latlng_string = event_latlng.toString();
                Toast.makeText(this, event_latlng_string, Toast.LENGTH_SHORT).show();
            }
        }
    }
    ...
    private void geoLocate(){
        ...
        Geocoder geocoder = new Geocoder(PickEventLocationActivity.this);
                ...
                location.addOnCompleteListener(new OnCompleteListener() {
                    ...
                    public void onComplete(@NonNull Task task) {
                        if(task.isSuccessful()){
                            ...
                            Toast.makeText(PickEventLocationActivity.this, "unable to get current location", Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
    ...
    private void moveCamera(LatLng latLng, float zoom, PlaceInfo placeInfo){
        ...
        mMap.setInfoWindowAdapter(new CustomInfoWindowAdapter(PickEventLocationActivity.this));
    ...
    private void initMap(){
        ...
        mapFragment.getMapAsync(PickEventLocationActivity.this);
    }
