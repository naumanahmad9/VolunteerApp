...
public class ArchivedEventsAdapter extends RecyclerView.Adapter<EventListViewHolder>{

    private ArrayList<Event> events;
    private Context mContext;
    private FirebaseDatabase database;

    public ArchivedEventsAdapter(ArrayList<Event> events, Context context) {
        this.events = events;
