...
public class Event {
    private String event_id, event_title, event_userName, event_userId, event_description,
    ...
    private float event_averageRating;
    private int event__viewcount;

    public Event(String event_id, String event_title, String event_userName, String event_userId,
    ...
    public float getEvent_averageRating() {
        return event_averageRating;
    }

    public void setEvent_averageRating(float event_averageRating) {
        this.event_averageRating = event_averageRating;
    }
